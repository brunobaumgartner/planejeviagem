  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-br from-sky-100 to-sky-200 rounded-full blur-3xl opacity-60"
          style={{
            width: "160px",
            height: "160px",
            left: "-20px",
        ...
        >
          ...
          <path
            ...
            style={{
              ...
              animation:
                "drawPath 1.5s ease-out forwards, fade-in 0.3s ease-out forwards",
            }}
          />
